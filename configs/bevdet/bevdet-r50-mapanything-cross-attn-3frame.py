...
custom_imports = dict(
    imports=['mmdet3d.models.detectors.bevdet_mapanything_cross_attn'],
...
model = dict(
    type='BEVDet4DMapAnythingCrossAttn',
    num_adj=len(range(*multi_adj_frame_id_cfg)),
    explicit_geo_encoding=dict(
        enabled=True,
    ...
    mapanything_cross_attn=dict(
        name='mapanything_bevdet_cross_attn',
        use_ifr=True,
        force_random_init=True,
        pretrained_checkpoint_path=None,
        input_embed_dim=256,
        num_views=data_config['Ncams'] * (len(range(*multi_adj_frame_id_cfg)) + 1),
        depth=4,
        indices=[1, 3],
        ...
        norm_cross_tokens=True,
        use_scalable_softmax=False,
